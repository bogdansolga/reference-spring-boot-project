...
import com.great.project.domain.repository.ProductRepository;
...
class ProductServiceTest {
    ...
    void givenThereAreAvailableProducts_whenRetrievingAProductById_thenTheProductIsCorrectlyRetrieved() {
        ...
        assertNotNull(resulted);
        assertThat(resulted.name(), is(mockedName));
    ...
    @Test
    @DisplayName("Given a product is saved, when saving the product then save is called one time and the response is not null or empty")
